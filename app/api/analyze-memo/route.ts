...
{"companyName":"企業名（不明ならnull）","industry":"agriculture|fishing|mining|construction|manufacturing|utility|it|logistics|retail|finance|real_estate|professional|food_service|beauty|education|medical|other|null","companySize":"under50|under200|under500|under1000|over1000|null","challenges":["抽出した課題キー: reduce_training_time|standardize_quality|eliminate_dependency|reduce_cost|improve_compliance|support_foreign_staff|dx_promotion|multi_location_gap|high_turnover|audit_readiness"],"primaryGoal":"reduce_training_time|standardize_quality|eliminate_dependency|reduce_cost|improve_compliance|support_foreign_staff|dx_promotion|null","currentUseCases":"現在の用途（自由記述、なければnull）","usageStatus":"none|partial|active|expanding|null","operationalBarriers":["no_time_for_creation","no_team_structure","low_it_literacy","hard_to_involve","migration_burden","no_creation_knowhow","maintenance_concern","low_adoption_concern"],"bottleneckHints":[{"area":"端末環境|体制|リテラシー|既存マニュアル|更新運用|その他","hint":"確認すべき内容","severity":"要確認|注意|参考"}],"missingFields":["不足しているフィールド名"],"rawInsights":"メモから読み取れたその他の重要な情報"}`
