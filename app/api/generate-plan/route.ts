...
// コアプラン用スキーマ（小さく保つ）
const CORE_SCHEMA = `JSONのみ:
{"summary":"2〜3文","phases":[{"name":"名","period":"期間","goal":"1文","kpi":"KPI","actions":[{"title":"名","description":"1〜2文","owner":"担当"}]}],"schedule":[{"month":1,"title":"テーマ","actions":["アクション"],"isReviewPoint":false}],"barrierActions":["1〜2文"],"kpiTargets":[{"kpi":"名","target":"値","timing":"時期"}]}`
