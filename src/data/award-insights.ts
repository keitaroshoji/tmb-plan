...
export const AWARD_INSIGHTS: InterviewInsight[] = [
  ...
  {
    id: 'award23-yamanami-01',
    company: 'Award2023年最優秀賞 ヤマナミ麺芸社',
    industry: 'food_service',
    challenges: ['talent_development', 'standardization'],
    barriers: ['low_adoption_concern', 'maintenance_concern'],
    ...
    source: 'Award2023年最優秀賞',
  },
  {
    id: 'award23-yamanami-02',
    company: 'Award2023年最優秀賞 ヤマナミ麺芸社',
    industry: 'food_service',
    challenges: ['standardization', 'knowledge_transfer'],
  ...
  {
    id: 'award23-gfoot-01',
    company: 'Award2023年優秀賞 ジーフット（靴小売600店舗）',
    industry: 'retail',
    challenges: ['standardization', 'multi_store'],
    ...
    source: 'Award2023年優秀賞',
  },
  {
    id: 'award23-sumitomo-rubber-01',
    company: 'Award2023年優秀賞 住友ゴム工業（製造、3.8万人）',
    industry: 'manufacturing',
  ...
  {
    id: 'award23-toa-dkk-01',
    company: 'Award2023年ベストルーキー賞 東亜ディーケーケー（製造）',
    industry: 'manufacturing',
    challenges: ['standardization', 'knowledge_transfer'],
    ...
    source: 'Award2023年ベストルーキー賞',
  },
  {
    id: 'award23-florence-01',
    company: 'Award2023年ダイバーシティ賞 フローレンス（保育・福祉）',
    industry: 'medical',
    ...
    source: 'Award2023年ダイバーシティ賞',
  },
  {
    id: 'award23-jnc-01',
    company: 'Award2023年ダイバーシティ賞 ジェイアンドシー（商社、外国籍1/3）',
  ...
  {
    id: 'award23-romu-service-01',
    company: 'Award2023年社会貢献賞 労務サービス（社労士法人）',
    industry: 'professional',
    challenges: ['knowledge_transfer', 'standardization'],
    ...
    source: 'Award2023年社会貢献賞',
  },
  {
    id: 'award23-bbc-01',
    company: 'Award2023年社会貢献賞 ビー・ビー・コミュニケーションズ（IT）',
    industry: 'it',
    challenges: ['knowledge_transfer', 'standardization'],
  ...
  {
    id: 'award23-resort-trust-01',
    company: 'Award2023年シナジークリエイション賞 リゾートトラスト（ホテル、8,000人）',
    industry: 'food_service',
    challenges: ['talent_development', 'standardization'],
